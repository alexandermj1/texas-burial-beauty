...
export function buildReminderHtml(firstName: string, cemetery: string | null, items: Missing[], link: string) {
  const rows = items.map((item) => `<tr><td style="padding:12px 14px;border-bottom:1px solid #f1e6da;font-size:14px;line-height:1.5;color:#2d2a26;"><span style="color:#7c3a2e;padding-right:10px;">&#10003;</span>${esc(itemText(item))}</td></tr>`).join("");
  return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Texas Cemetery Brokers</title></head><body data-tcb-email="auto_followup" style="margin:0;padding:0;background:#f7f3ee;font-family:Georgia,'Times New Roman',serif;color:#1f2937;"><div style="display:none;max-height:0;overflow:hidden;opacity:0;">A friendly reminder about the remaining documents for your cemetery property.</div><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f7f3ee;padding:32px 16px;"><tr><td align="center"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px;background:#ffffff;border:1px solid #ead9c9;border-radius:14px;overflow:hidden;"><tr><td style="padding:28px 32px;border-bottom:1px solid #f1e6da;text-align:center;"><div style="font-family:Georgia,'Times New Roman',serif;font-size:22px;letter-spacing:.18em;color:#7c3a2e;font-weight:600;">TEXAS CEMETERY BROKERS</div><div style="font-family:Arial,sans-serif;font-size:11px;letter-spacing:.28em;color:#a08a76;margin-top:6px;text-transform:uppercase;">Serving all of Texas</div></td></tr><tr><td style="padding:32px 40px;font-size:15px;line-height:1.7;color:#2d2a26;"><div style="font-family:Arial,sans-serif;font-size:11px;letter-spacing:.22em;color:#7c3a2e;text-transform:uppercase;margin:0 0 14px;">Document reminder</div><p style="margin:0 0 16px;">Dear ${esc(firstName)},</p><p style="margin:0 0 18px;">I hope you are well. We are preparing your file so we can move quickly when we find the right buyer${cemetery ? ` for your property at ${esc(cemetery)}` : ""}.</p><p style="margin:0 0 12px;">When convenient, could you please send us the following outstanding ${items.length === 1 ? "item" : "items"}?</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 26px;border:1px solid #ead9c9;border-radius:8px;background:#faf6f0;overflow:hidden;">${rows}</table><table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 24px;"><tr><td align="center" style="background:#7c3a2e;border-radius:8px;"><a href="${esc(link)}" style="display:inline-block;padding:15px 32px;color:#ffffff;text-decoration:none;font-family:Arial,sans-serif;font-size:15px;font-weight:600;">Open your document page&nbsp;&nbsp;&rarr;</a></td></tr></table><p style="margin:0 0 18px;font-family:Arial,sans-serif;font-size:13px;line-height:1.7;color:#65594f;">If you have already sent something, or you have spoken with us about it, please reply to this email or call <a href="tel:+12142304740" style="color:#7c3a2e;text-decoration:none;"><strong>(214) 230-4740</strong></a>. We will update your file straight away.</p><p style="margin:0;font-size:14px;line-height:1.7;color:#2d2a26;">Warm regards,<br><strong>Alexander James</strong><br><span style="font-family:Arial,sans-serif;font-size:12px;color:#8a7766;">Cemetery Salesperson<br>Texas Cemetery Brokers</span></p></td></tr><tr><td style="padding:20px 32px;border-top:1px solid #f1e6da;text-align:center;font-family:Arial,sans-serif;font-size:12px;color:#8a7766;"><a href="https://www.texascemeterybrokers.com" style="color:#7c3a2e;text-decoration:none;">www.texascemeterybrokers.com</a><span style="color:#c8b8aa;"> &nbsp;·&nbsp; </span><a href="tel:+12142304740" style="color:#7c3a2e;text-decoration:none;">(214) 230-4740</a></td></tr></table></td></tr></table></body></html>`;
}
...
const buildPlain = (first: string, cemetery: string | null, items: Missing[], link: string) => [
  ...
  "If you have already sent something, or you have spoken with us about it, please reply or call (214) 230-4740. We will update your file straight away.", "", "Warm regards,", "Alexander James", "Cemetery Salesperson", "Texas Cemetery Brokers",
].join("\n");
