...
const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <>
        ...
        <p className="text-lg leading-relaxed text-foreground/80 mb-6">Selling cemetery property can be complicated. Working with our team of professionals, who have been helping families in the Bay Area for 30 years, will allow you peace of mind and a stress-free process.</p>
        <p className="text-lg leading-relaxed text-foreground/80 mb-8">Cemetery Property Resales has extensive knowledge and a wonderful reputation in cemeteries such as <strong className="text-foreground">Holy Sepulchre Cemetery</strong> Hayward, <strong className="text-foreground">Skylawn Memorial Park</strong> San Mateo, <strong className="text-foreground">Chapel of the Chimes</strong> Hayward, <strong className="text-foreground">Los Gatos Memorial Park</strong> San Jose, <strong className="text-foreground">Oak Hill</strong> San Jose, <strong className="text-foreground">Rolling Hills</strong> Concord, <strong className="text-foreground">Memory Gardens</strong> Concord and Livermore, <strong className="text-foreground">Oakmont</strong> Lafayette and many others in the Bay Area.</p>
        ...
        <div className="bg-card rounded-2xl p-8 shadow-soft border border-border/50 my-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="tel:+16503720795" className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground font-medium rounded-full text-sm hover:opacity-90 transition-all"><Phone className="w-4 h-4" /> (650) 372-0795</a>
            <a href="mailto:help@cemeteryproperty.com" className="inline-flex items-center gap-2 px-6 py-3 bg-foreground text-background font-medium rounded-full text-sm hover:opacity-90 transition-all"><Mail className="w-4 h-4" /> help@cemeteryproperty.com</a>
          </div>
        </div>
      </>
    ),
