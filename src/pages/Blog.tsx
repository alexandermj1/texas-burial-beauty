...
const blogPosts: BlogPost[] = [
  {
    ...
    content: (
      <>
        ...
        <p className="text-lg leading-relaxed text-foreground/80 mb-6">Selling cemetery property can be complicated. Working with our team of Texas professionals — backed by 29+ years of resale experience through our partnership with Bayer Cemetery Brokers — gives you peace of mind and a stress-free process.</p>
