...
const Admin = () => {
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-card rounded-2xl p-8 shadow-soft w-full max-w-sm">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-2.5 bg-foreground text-background font-medium rounded-full text-sm hover:opacity-90 transition-opacity disabled:opacity-50 inline-flex items-center justify-center gap-2"
              >
                <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true"><path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6.1 29.5 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.3-.1-2.3-.4-3.5z"/><path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 16 19 13 24 13c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 7 29.5 4.9 24 4.9 16 4.9 9.1 9.7 6.3 14.7z"/><path fill="#4CAF50" d="M24 44c5.4 0 10.3-2.1 14-5.4l-6.5-5.5C29.6 34.5 26.9 35.5 24 35.5c-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.1 38.3 16 44 24 44z"/><path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4-4 5.3l6.5 5.5C41.9 35 44 30 44 24c0-1.3-.1-2.3-.4-3.5z"/></svg>
                Continue with Google
              </button>
              <button
                onClick={() => handleOAuth("apple")}
                disabled={loginLoading}
                className="w-full py-2.5 bg-background border border-border text-foreground font-medium rounded-full text-sm hover:bg-muted transition-colors disabled:opacity-50 inline-flex items-center justify-center gap-2"
              >
                <svg width="14" height="14" viewBox="0 0 384 512" fill="currentColor" aria-hidden="true"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zM277.4 80.4c20.9-24.8 19-47.4 18.4-55.4-18.5 1.1-39.9 12.6-52.1 26.8-13.4 15.2-21.3 34-19.6 54.5 20 1.5 38.3-8.8 53.3-25.9z"/></svg>
                Continue with Apple
              </button>
            </div>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-sand-light/60 via-background to-sage-light/40 dark:from-background dark:via-background dark:to-background">
      ...
      <div className={`hidden md:block lg:hidden md:!translate-y-0 transition-transform duration-200 ${navHiddenMobile ? "-translate-y-full" : "translate-y-0"}`}>
        <Navbar forceScrolled />
      </div>
      <section className={`flex-1 ${focused ? "pt-3 md:pt-6 lg:pt-5 pb-10" : "pt-4 md:pt-28 lg:pt-8 pb-16"}`}>
