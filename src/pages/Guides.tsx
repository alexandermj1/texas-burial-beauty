...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    dek: "Plot prices city by city, the fees cemeteries add on top, what resale spaces really sell for, and exactly what a broker charges.",
    status: "live",
    meta: "6 chapters · 7 min read",
  ...
  },
  {
    ...
    titleAccent: "Texas",
    dek: "Buying the space before it's needed — what preneed really means, why buying from an owner costs less than the cemetery's price list, and how to choose calmly instead of in the week of a funeral.",
    status: "live",
    meta: "9 chapters · 8 min read",
    panel: "bg-[hsl(200_28%_34%)]",
    panelInk: "text-[hsl(40_30%_97%)]",
    rule: "bg-[hsl(40_45%_82%)]",
    hero: FLORAL.plumeria,
    accent: FOLIAGE.banana,
