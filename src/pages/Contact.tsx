...
const Contact = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col [&>footer]:mt-auto">
      ...
      {/* ── General Inquiry ── */}
      <section id="general-inquiry" className="py-16 scroll-mt-20">
      ...
      {/* ── Buy Inquiry ── */}
      <section id="buy-inquiry" className="py-16 bg-gradient-sage relative overflow-hidden scroll-mt-20">
      ...
      {/* ── Sell Inquiry ── */}
      <section id="sell-inquiry" className="py-16 relative overflow-hidden scroll-mt-20">
