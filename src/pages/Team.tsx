        ...
        <div className="relative container mx-auto px-6 pb-12 pt-32 text-center">
          ...
          >
            ...
            <p className="text-primary-foreground/75 max-w-2xl mx-auto text-lg leading-relaxed drop-shadow-sm">
              A dedicated team of licensed professionals — Texas-based brokers backed by a 27-year partner network — helping families across Dallas, Houston, Austin and San Antonio.
            </p>
          </motion.div>
        </div>
      </section>
