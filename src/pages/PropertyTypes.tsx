...
const propertyTypes = [
  { id: "single-plot", title: "Single Burial Plot", subtitle: "The traditional choice — 1 casket", image: singlePlotImg, description: "A single in-ground plot for one casket burial, typically marked with a flat bronze or granite memorial set level with the ground.", features: ["The most widely available and most affordable in-ground option", "Found in nearly every Texas cemetery", "Flat markers preserve the open, garden-like feel of the grounds", "Most cemeteries will permit one or two cremation urns to be interred in the same plot, with prior approval"], stat: { value: "1", unit: "Casket", detail: "Flat bronze or granite marker" }, pullQuote: "A traditional resting place, simply and well kept." },
  { id: "companion-plot", title: "Companion Plot", subtitle: "Side by side — 2 spaces", image: companionPlotImg, description: "Two adjoining plots intended for a couple or two family members, often with matching memorials that read as a single tribute.", features: ["Most commonly chosen by spouses and life partners", "Frequently priced lower than two single plots purchased separately", "Matching markers create one unified place of remembrance", "Some cemeteries allow double-depth burial in a single plot footprint, where two caskets are interred one above the other"], stat: { value: "2", unit: "Spaces", detail: "Side by side" }, pullQuote: "For those who shared a life, a place to rest together." },
  { id: "lawn-crypt", title: "Lawn Crypt", subtitle: "In-ground, pre-built — 1 or 2 burials", image: lawnCryptImg, description: "An in-ground burial space with the outer burial vault already installed. Many lawn crypts are built for two, allowing a second casket to be placed above the first.", features: ["The outer vault is included in the price", "Maintains the level, well-kept appearance of a lawn section", "A double-depth crypt accommodates two burials in the area of a single plot", "Visually indistinguishable from a traditional burial section once the marker is set"], stat: { value: "1–2", unit: "Burials", detail: "Vault pre-installed" }, pullQuote: "The familiar look of a lawn section, with the vault already in place." },
  { id: "mausoleum-crypt", title: "Mausoleum Crypt", subtitle: "Above-ground entombment — 1 or 2 entombments", image: mausoleumImg, description: "Above-ground entombment within a mausoleum building or garden mausoleum. Spaces may be single, tandem (one casket placed behind another), or companion (side-by-side).", features: ["No graveside exposure to the ground or weather during the service", "Indoor mausoleums offer year-round, sheltered visitation", "Couples often choose companion crypts to rest together", "A preferred option for families who do not wish to be buried in the ground"], stat: { value: "1–2", unit: "Entombments", detail: "Indoor or outdoor" }, pullQuote: "A sheltered resting place above ground." },
  { id: "cremation-niche", title: "Cremation Niche", subtitle: "For cremated remains — 1 or 2 urns", image: cremationNicheImg, description: "A compartment within a columbarium that holds one or two cremation urns. Niche fronts are available in granite, marble, bronze, or glass; glass fronts allow the urn and small keepsakes to be visible.", features: ["Typically the most affordable permanent memorial option", "Single and companion sizes are widely available", "Indoor niches are protected from the elements", "A dignified resting place for families who choose cremation"], stat: { value: "1–2", unit: "Urns", detail: "Granite · Marble · Bronze · Glass" }, pullQuote: "A quiet, personal place of remembrance." },
  { id: "family-estate", title: "Family Estate", subtitle: "For generations — 4 to 8+ burials", image: familyEstateImg, description: "A larger lot purchased as a single parcel, usually with a central upright monument carrying the family name and individual markers for each interment.", features: ["Accommodates four to eight or more interments, depending on cemetery rules and lot dimensions", "Generally located in prominent, established areas of the cemetery", "Often passed down and used by a family across multiple generations", "Many cemeteries permit a mix of casket and cremation interments within the estate"], stat: { value: "4–8+", unit: "Burials", detail: "Central upright monument" }, pullQuote: "A family's name, kept in one place across generations." },
  { id: "veterans-garden", title: "Veterans Section", subtitle: "Honoring service — military honors", image: veteransGardenImg, description: "Areas of the cemetery set aside for veterans and, in most cases, their spouses. Eligible veterans qualify for a government-issued marker and military funeral honors.", features: ["Dedicated sections recognizing service to the country", "Government markers and flag presentations available to those who qualify", "Generally situated in well-maintained, prominent areas of the grounds", "Spouses are typically eligible for interment in the same section"], stat: { value: "★", unit: "Military", detail: "Government marker eligible" }, pullQuote: "A resting place that recognizes a lifetime of service." },
];
        ...
        <motion.div style={{ opacity: heroOpacity, y: heroTextY }} className="relative container mx-auto px-6">
          <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }} className="max-w-3xl">
            ...
            <p className="text-primary-foreground/80 text-base md:text-lg font-light leading-relaxed max-w-2xl drop-shadow-md">
              A plain-language guide to the memorial choices available to Texas families.
            </p>
          </motion.div>
        </motion.div>
      </section>
      ...
      <section className="py-14 md:py-20 bg-gradient-sage">
        <div className="container mx-auto px-6 max-w-3xl text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="font-display text-3xl md:text-4xl text-foreground mb-4">Not sure which option is right?</h2>
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">We don't expect families to know the difference between a lawn crypt and a companion plot — that's our job. Call or email and we'll walk you through every option in plain language, at your pace, with no pressure.</p>
