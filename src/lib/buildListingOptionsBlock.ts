  ...
  <tr><td style="padding:24px 26px;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:${BRAND_BG_ACCENT};border-radius:8px;margin:14px 0 16px;">
      <tr><td style="padding:18px 20px;">
        ...
        ${plotCount > 1 ? `<p style="font-family:${SANS};font-size:13px;color:${BRAND_INK_MUTED};margin:8px 0 0;">${fmtUsd(totalSale)} across all ${plotCount} spaces${fee > 0 ? ` (the cemetery's ${fmtUsd(fee)} transfer fee is charged once per transfer, not per space)` : ""}</p>` : ""}
      </td></tr>
    </table>
