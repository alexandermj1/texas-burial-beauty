...
export const FLAGSHIP_CEMETERIES: FlagshipCemetery[] = [
  ...
  },
  {
    ...
    intro: [
      "Bluebonnet Hills on Colleyville Boulevard serves the Mid-Cities — Colleyville, Grapevine, Southlake, Bedford and Hurst — and it is the second-busiest cemetery in our Dallas–Fort Worth book. Families here tend to buy in named gardens rather than numbered sections, and they buy in groups of two and four.",
      "Its garden structure is unusually legible, which makes resale easy to match: an owner releasing two spaces in Garden of Tranquility is speaking exactly the same language as the buyer looking for them. That is why Mid-Cities spaces move quickly through us.",
    ],
    facts: [
      { label: "City", value: "Colleyville (Mid-Cities)" },
      { label: "Operator", value: "Dignity Memorial" },
      { label: "Transfer fee", value: "$595 per space" },
      { label: "Resale demand", value: "Very high — #2 in DFW" },
    ],
    sections: [
      { name: "Garden of Tranquility", kind: "Ground", tier: "premium", note: "Most requested garden here; contiguous pairs and fours trade regularly." },
      { name: "Garden of Devotion", kind: "Ground", tier: "premium", note: "Established feature garden, typically resale only." },
