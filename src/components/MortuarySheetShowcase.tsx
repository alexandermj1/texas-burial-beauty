...
const points = [
  "Sent every fortnight to funeral homes, mortuaries and family counselors across Texas",
  "Featured listings open the sheet with an expanded description and photography",
